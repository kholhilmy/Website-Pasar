...
<main class="h-full pb-16 overflow-y-auto">
    <div class="container grid px-6 mx-auto">
        <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">Update Pasar</h2>

        <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
            <form method="POST" action="/pasar/{{ $pasar->id }}">
                @method('PUT')
                @csrf
                ...
                <div class="mb-4">
                    <label class="block text-sm" for="nama">
                        ...
                        <input
                            ...
                            placeholder="Nama Pasar" id="nama" name="nama" value="{{ $pasar->nama_pasar }}" required
                        />
                    </label>
                </div>
