...
<main class="h-full pb-16 overflow-y-auto">
    ...
    <div class="flex my-6 justify-between">
            <div class="flex">
                ...
                <h2 class="text-2xl font-semibold text-gray-700 dark:text-gray-200">Riwayat Kepemilikan {{ $kepemilikan->tenant->nama_tenant }}</h2>
            </div>
            <div>
                <a
                ...
                href="/riwayat-kepemilikan/{{ $kepemilikan->id }}/cetak-kepemilikan"
                >
    ...
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
        ...
        <table class="w-full whitespace-no-wrap">
            ...
            {{-- <tr>
                <td>
                    @foreach ($histori->tenant as $item)
                        {{ $item->nama_tenant }}
                    @endforeach
